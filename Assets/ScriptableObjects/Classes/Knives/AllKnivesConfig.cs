...
{
	[CreateAssetMenu(
		menuName = "Configs/Knives/Create AllKnivesConfig", 
		fileName = "AllKnivesConfig", 
		order = 0)
	]
	public class AllKnivesConfig : ScriptableObject
	{
		[SerializeField] private List<KnifeConfig> _configs;
		
		private Dictionary<KnifeType, KnifeConfig> _cachedConfigs;

		public KnifeConfig GetConfig(KnifeType type)
		{
